(function (j, h, c, g, d, k, f) {/*! Jssor */
    ...
    var b = j.$Jssor$ = new function () {
        var i = this, zb = /\S+/g, M = 1, jb = 2, mb = 3, lb = 4, pb = 5, N, t = 0, l = 0, u = 0, B = 0, C = 0,
            F = navigator, ub = F.appName, o = F.userAgent, A = h.documentElement, q = parseFloat;

        function Ib() {
            if (!N) {
                N = {ug: "ontouchstart" in j || "createTouch" in h};
                var a;
        ...
        i.$WindowSize = function () {
            var a = h.body;
            return {x: a.clientWidth || A.clientWidth, y: a.clientHeight || A.clientHeight}
        };
        function x(c, d, a) {
        ...
        i.Wf = function (a, b) {
            if (r() && u < 9 || u < 10 && ib()) a.style.zoom = b == 1 ? "" : b; else {
                var c = O(a), f = "scale(" + b + ")", e = a.style[c], g = new RegExp(/[\s]*scale\(.*?\)/g),
                    d = E(e, [g], f);
                a.style[c] = d
            }
        };
        ...
        var V = {$Top: g, $Right: g, $Bottom: g, $Left: g, v: g, u: g};
        i.rf = function (a) {
            var b = i.$CreateDiv();
            s(b, {tf: "block", mb: i.J(a), $Top: 0, $Left: 0, v: 0, u: 0});
            var d = i.sd(a, V);
            i.Db(b, a);
            i.$AppendChild(b, a);
            var e = i.sd(a, V), c = {};
        ...
        function Fb(a) {
            var l = this, p = "", r = ["av", "pv", "ds", "dn"], d = [], q, k = 0, g = 0, e = 0;
        ...
        function s(h, l) {
            var e = gb(), b = I(), d = eb(), j = O(h);

            function k(b, d, a) {
                var e = b.kb(p(-d / 2, -a / 2)), f = b.kb(p(d / 2, -a / 2)), g = b.kb(p(d / 2, a / 2)),
                    h = b.kb(p(-d / 2, a / 2));
                b.kb(p(300, 300));
            ...
            function a(d, a) {
                ...
                if (b) {
                    ...
                    var s = d.style.filter,
                        t = new RegExp(/[\s]*progid:DXImageTransform\.Microsoft\.Matrix\([^\)]*\)/g), r = E(s, [t], o);
                    T(d, r)
                }
            }
            ...
            s = function (e, c) {
                ...
                if (c.ng)if (d) xb(i.$CreateCallback(g, Q, e, c)); else a(e, c)
            };
            i.nc = Q;
            if (d) i.nc = s;
            if (e) i.nc = a; else if (!b) a = Q;
            i.I = s;
            s(h, l)
        }
        ...
        i.Jc = function (c, d) {
            var a = c || {};
            if (c)if (b.Zd(c)) a = {Y: a}; else if (b.Zd(c.$Clip)) a.$Clip = {Y: c.$Clip};
            a.Y = a.Y || d;
        ...
        function vb(c, a) {
            ...
            n(c, function (c, d) {
                var e = c;
                if (a[d] != f)if (i.fc(c)) e = c + a[d]; else e = vb(c, a[d]);
                b[d] = e
            });
            return b
        }
        ...
        i.Sc = function (n, j, s, t, B, C, o) {
            ...
            if (n) {
                ...
                for (var i in j) {
                    ...
                    var x = c.floor(h);
                    if (h != x) h -= x;
                    var k = t.Y || e.$Linear, m, E = n[i], q = j[i];
                    if (b.fc(q)) {
                        k = t[i] || k;
                        var A = k(h);
                        m = E + q * A
            ...
            if (j.$Clip && o.$Move) {
                var p = a.$Clip.ec, v = (p.$Top || 0) + (p.$Bottom || 0), u = (p.$Left || 0) + (p.$Right || 0);
                a.$Left = (a.$Left || 0) + u;
                a.$Top = (a.$Top || 0) + v;
                a.$Clip.$Left -= u;
                a.$Clip.$Right -= u;
    ...
    var l = function (A, D, g, L, O, J) {
        ...
        function K() {
            if (p) {
                var d = b.R(), e = c.min(d - B, g.bd), a = h + e * n;
                B = d;
                if (a * n >= m * n) a = m;
                s(a);
    ...
    var m = {Hb: "data-scale", tc: "data-scale-ratio", vb: "data-autocenter"}, n = new function () {
        var a = this;
        ...
        h.$FormationStraight = function (f) {
            for (var d = f.$Cols, e = f.$Rows, s = f.$Assembly, t = f.Yb, r = [], a = 0, b = 0, p = d - 1, q = e - 1, h = t - 1, c, b = 0; b < e; b++)for (a = 0; a < d; a++) {
                switch (s) {
                    case j:
                        c = h - (a * e + (q - b));
                        break;
        ...
        h.$FormationSwirl = function (q) {
            var x = q.$Cols, y = q.$Rows, B = q.$Assembly, w = q.Yb, A = [], z = [], u = 0, c = 0, h = 0, r = x - 1,
                s = y - 1, t, p, v = 0;
            switch (B) {
                case j:
                    c = r;
        ...
        h.$FormationZigZag = function (p) {
            var w = p.$Cols, x = p.$Rows, z = p.$Assembly, v = p.Yb, t = [], u = 0, c = 0, d = 0, q = w - 1, r = x - 1,
                y, h, s = 0;
            switch (z) {
                case j:
                    c = q;
        ...
        h.$FormationStraightStairs = function (q) {
            var u = q.$Cols, v = q.$Rows, e = q.$Assembly, t = q.Yb, r = [], s = 0, c = 0, d = 0, f = u - 1, h = v - 1,
                x = t - 1;
            switch (e) {
                case j:
                case m:
    ...
    j.$JssorSlideshowRunner$ = function (m, s, p, u, z, A) {
        var a = this, v, h, f, y = 0, x = u.$TransitionsOrder, r, i = 8;
        ...
        function j(g, f) {
            ...
            a.qe = function (c, b) {
                ...
                if (!a.bc[f]) {
                    a.bc[f] = {v: c, u: b};
                    for (var d = 0; d < a.$Cols; d++)for (var e = 0; e < a.$Rows; e++)a.bc[f][e + "," + d] = {
                        $Top: e * b,
                        $Right: d * c + c,
                        $Bottom: e * b + b,
                        $Left: d * c
        ...
        function n(z, i, a, v, n, l) {
            var y = this, t, u = {}, h = {}, m = [], f, e, r, p = a.$ChessMode.$Column || 0, q = a.$ChessMode.$Row || 0,
                g = a.qe(n, l), o = B(a), C = o.length - 1, s = a.$Duration + a.$Delay * C, w = v + s, j = a.$SlideOut,
                x;
            w += 50;
            function B(a) {
                var b = a.$Formation(a);
            ...
            y.hc = function (d) {
                ...
                if (e || x) {
                    ...
                    b.$Each(h, function (a, e) {
                        ...
                        if (a.Yc != d) {
                            if (!a.Yc && !j) b.D(m[e]); else d == a.ue && j && b.V(m[e]);
                            a.Yc = d;
                            b.I(m[e], a[d])
                        }
                    })
            ...
            b.$Each(o, function (i, m) {
                b.$Each(i, function (G) {
                    ...
                    if (K) {
                        ...
                        if (a.$Clip) {
                            ...
                            if (C && z) {
                                i.$Top = g.u / 2 * w;
                                i.$Bottom = -i.$Top
                            } else if (C) i.$Bottom = -g.u * w; else if (z) i.$Top = g.u * w;
                            if (B && A) {
                                i.$Left = g.v / 2 * w;
                                i.$Right = -i.$Left
                            } else if (B) i.$Right = -g.v * w; else if (A) i.$Left = g.v * w
                        }
                        r.$Clip = t;
                        f.$Clip = g[v]
                    }
                    ...
                    u[v] = j ? f : e;
                    var D = a.ee, y = c.round(m * a.$Delay / a.$Interval);
                    h[v] = new Array(y);
                    h[v].Ae = y;
                    h[v].ue = y + D - 1;
                    for (var F = 0; F <= D; F++) {
        ...
        a.Re = function (w, x, k, l, b) {
            ...
            g["no-image"] = !l.jc;
            e["no-image"] = !k.jc;
            var o = g, q = e, u = b, d = b.$Brother || j({}, i);
            if (!b.$SlideOut) {
                o = e;
                q = g
            }
            ...
            f = new n(m, o, u, c.max(d.$Interval - t, 0), s, p);
            h.hc(0);
            f.hc(0);
            v = c.max(h.ed, f.ed);
            a.wb = w
    ...
    j.$JssorBulletNavigator$ = function (a, E) {
        ...
        f.Pb = e = b.s({$SpacingX: 10, $SpacingY: 10, $Orientation: 1, $ActionMode: 1}, E);
    ...
    j.$JssorThumbnailNavigator$ = function (h, D) {
        var j = this, A, s, a, x = [], B, z, e, t, u, w, v, r, l, f, q;
        o.call(j);
        h = b.$GetElement(h);
        function C(o, f) {
            var h = this, c, n, m;
            ...
            function i(g) {
                if (g || !l.De()) {
                    var a = e - f % e, b = l.gd((f + a) / e - 1), c = b * e + e - a;
                    j.j(p.Ob, c, k, d)
                }
            }
        ...
        j.Nc = function (G, D) {
            if (!y) {
                ...
                s = -1;
                r = c.min(r, D.length);
                var g = a.$Orientation & 1, o = w + (w + t) * (e - 1) * (1 - g), n = v + (v + u) * (e - 1) * g,
                    q = o + (o + t) * (r - 1) * g, p = n + (n + u) * (r - 1) * (1 - g);
                b.J(f, "absolute");
                b.Ab(f, "hidden");
                b.z(f, (B - q) / 2);
                b.C(f, (z - p) / 2);
                ...
                b.$Each(D, function (k, h) {
                    var i = new C(k, h), d = i.dc, a = c.floor(h / e), j = h % e;
                    b.z(d, (w + t) * j * (1 - g));
                    b.C(d, (v + u) * j * g);
                    if (!m[a]) {
                        m[a] = b.$CreateDiv();
        ...
        j.Pb = a = b.s({$SpacingX: 0, $SpacingY: 0, $Cols: 1, $Orientation: 1, $ActionMode: 1}, D);
        B = b.$CssWidth(h);
        z = b.$CssHeight(h);
    ...
    j.$JssorCaptionSlideo$ = function (v, j, u, E) {
        var a = this, w, o = {}, p = j.$Transitions, s = j.$Controls, m = new l(0, 0), q = [], h = [], D = E,
            f = D ? 1e8 : 0;
        l.call(a, 0, 0);
        function r(d, c) {
            var a = {};
            b.$Each(d, function (d, f) {
                var e = o[f];
                if (e) {
                    if (b.Wd(d)) d = r(d, c || f == "e"); else if (c)if (b.fc(d)) d = w[d];
                    a[e] = d
                }
            });
            return a
        ...
        function t(d, e) {
            ...
            b.$Each(c, function (c) {
                ...
                if (h) {
                    var d = b.$AttributeEx(c, "t"), g = p[b.Qc(d)] || p[d], f = {$Elmt: c, sc: g};
                    a.push(f)
                }
                a = a.concat(t(c, e + 1))
            });
        ...
        function z(t, u, h) {
            ...
            b.$Each(u, function (i) {
                var g = b.s(d, {}, r(i)), j = b.Jc(g.$Easing);
                delete g.$Easing;
                if (g.$Left) {
                    g.B = g.$Left;
                    j.B = j.$Left;
                ...
                var o = {$Easing: j, $OriginalWidth: h.v, $OriginalHeight: h.u}, k = new l(i.b, i.d, o, t, h, g);
                f = c.max(f, i.b + i.d);
                if (a) {
                    if (!e) e = new l(i.b, 0);
                    e.O(k)
            ...
            if (a && e) {
                e.ce();
                var i = e, k, j = e.mc(), p = e.sb(), q = c.max(p, a.Nf);
                if (a.Z < p) {
                    if (a.Z > j) {
                        i = new l(j, a.Z - j);
                        i.O(e, d)
                    } else i = g;
                    k = new l(a.Z, q - j, {Kc: q - a.Z, af: d});
                    k.O(e, d)
                }
                i && a.yc.push(i);
                k && a.Yd.push(k)
        ...
        function i(k, d, e) {
            ...
            if (g > 4)for (var m = c.ceil(g / 4), a = 0; a < m; a++) {
                var h = d.slice(a * 4, c.min(a * 4 + 4, g)), j = new l(h[0].Z, 0);
                i(j, h, e);
                k.O(j)
        ...
        y(t(v, 1));
        i(m, h);
        var x = j.$Breaks || [], k = [].concat(x[b.Qc(b.$AttributeEx(v, "b"))] || []);
    ...
    var i = j.$JssorSlider$ = function () {
        var a = this;
        b.Ff(a, o);
        var ub = "data-jssor-slider", Vb = "data-jssor-thumb", u, n, X, fb, V, jb, U, eb, S, Q, Nb, ic, mc = 1, hc = 1,
            Wb = 1, Zb = {}, gc, z, P, sb, Pb, Mb, ib, wb, vb, db, s = -1, L, zb, q, I, H, Jb, ob, pb, qb, t, R, x, N,
            Lb, Z = [], dc, ec, ac, nc, Ic, w, gb, F, cc, nb, xb, Ab, mb, Bb, J, hb, O, G = 1, T, D, Y, Cb = 0, Db = 0,
            K, kb, lb, Qb, y, bb, A, Eb, ab = [], Rb = b.$Device(), Hb = Rb.ug, B = [], C, M, E, tb, Ub, W;

        function vc(e, n, o) {
            var k = this, h = {$Top: 2, $Right: 1, $Bottom: 2, $Left: 1},
                l = {$Top: "top", $Right: "right", $Bottom: "bottom", $Left: "left"}, g, a, f, i, j = {};
            k.$Elmt = e;
            k.$ScaleSize = function (q, k) {
                ...
                if (!f) {
                    f = b.rf(e);
                    g = e.parentNode;
                    i = {$Scale: b.gc(e, m.Hb, 1), $AutoCenter: b.gc(e, m.vb)};
        ...
        function Hc() {
            ...
            l.call(b, -1e8, 2e8);
            b.Xf = function () {
                var a = b.Ib(), d = c.floor(a), f = v(d), e = a - c.floor(a);
                return {wb: f, Zf: d, mb: e}
            };
            b.cc = function (e, b) {
                var f = c.floor(b);
                if (f != b && b > e) f++;
        ...
        function Fc() {
            var a = this, b = Eb.$Elmt;
            l.call(a, -1, 2, {$Easing: e.$Linear, mf: {mb: lc}, Kc: q}, b, {mb: 1}, {mb: -2});
            a.dc = b
        }

        function xc(o, m) {
            var b = this, e, f, h, j, c;
            l.call(b, -1e8, 2e8, {bd: 100});
            b.id = function () {
                T = d;
                Y = g;
        ...
        function Ec(m, f) {
            var e = this, r, L, y, j, z = [], x, D, T, J, R, F, K, h, u, p;
            l.call(e, -t, t + 1, {});
            function E(a) {
                r && r.hd();
                S(m, a, 0);
                F = d;
                r = new V.$Class(m, V, b.cd(b.$AttributeEx(m, "idle")) || cc, !w);
                r.G(0)
            }
            ...
            function Z(b) {
                if (b == Y && s == f) {
                    if (!h) {
                        var a = g;
                        if (C)if (C.wb == f) a = C.We(); else C.xb();
                        W();
                        h = new Dc(m, f, a, r);
                        h.Nd(p)
                    }
            ...
            function G(a, d, k) {
                if (a == f) {
                    if (a != d) B[d] && B[d].Vd(); else!k && h && h.xg();
                    p && p.$Enable();
                    var l = Y = b.R();
                    e.Nb(b.$CreateCallback(g, Z, l))
                } else {
                    var j = c.min(f, a), i = c.max(f, a), o = c.min(i - j, j + q - i), m = t + n.$LazyLoading - 1;
                    (!R || o <= m) && e.Nb()
                }
            }
            ...
            function S(a, f, c, h) {
                ...
                b.$Each(i, function (a) {
                    ...
                    if (g == "player" && !u) {
                        u = a;
                        if (u.pInstance) Q(); else b.$AddEvent(u, "dataavailable", Q)
                    }
                    if (g == "caption") {
                        if (f) {
                            b.xf(a, b.$AttributeEx(a, "to"));
                            b.wf(a, b.$AttributeEx(a, "bf"));
                            K && b.$AttributeEx(a, "3d") && b.uf(a, "preserve-3d")
                        }
                    } else if (!F && !c && !j) {
                        if (e == "A") {
                            if (b.$AttributeEx(a, "u") == "image") j = b.Lf(a, "IMG"); else j = b.$FindChild(a, "image", d);
                            if (j) {
                                x = a;
                                b.rb(x, "block");
                                b.I(x, db);
        ...
        function Dc(z, g, p, q) {
            var c = this, n = 0, u = 0, h, j, f, e, m, t, r, o = B[g];
            l.call(c, 0, 0);
            function v() {
                b.uc(M);
                nc && m && o.Ed && b.$AppendChild(M, o.Ed);
                b.D(M, !m && o.jc)
            }
            ...
            c.Pc = function () {
                ...
                if (!D && !T && !r && s == g) {
                    ...
                    if (b != e)if (b == f) k = e; else if (b == j) k = f; else if (!b) k = j; else k = c.yd();
                    a.j(p, g, b, n, j, f, e);
                    var l = w && (!F || G);
                    if (b == e) (f != e && !(F & 12) || l) && o.kg(); else(l || b != f) && c.xd(k, x)
                }
            };
            c.xg = function () {
                f == e && f == c.Ib() && c.G(j)
            ...
            c.Od = function (a) {
                p && b.Ab(R, a && p.sc.$Outside ? "" : "hidden")
            };
            c.Lc = function (c, b) {
                if (m && b >= h) {
                    m = k;
        ...
        function lc(c, b) {
            var a = x > 0 ? x : X, d = ob * b * (a & 1), e = pb * b * (a >> 1 & 1);
            yb(c, d, e)
        }
        ...
        function kc(c, j) {
            ...
            Lb = k;
            var l = b.Lb(e, "1", Vb);
            if ((!l || l === u) && !N && (!j || c.touches.length == 1) && !b.Lb(e, "nodrag") && Cc()) {
                var n = b.Lb(e, f, m.tc);
                if (n) Wb = b.$Attribute(n, m.tc);
                if (j) {
                    var p = c.touches[0];
                    Cb = p.clientX;
                    Db = p.clientY
        ...
        function Ob(a) {
            if (D) {
                ...
                } else cb(); else e = b.Ld(a);
                if (e) {
                    var f = e.x - Cb, g = e.y - Db;
                    if (x || c.abs(f) > 1.5 || c.abs(g) > 1.5) {
                        ...
                        if (x && !Lb) {
                            ...
                            if (K - kb < -1.5) lb = 0; else if (K - kb > 1.5) lb = -1;
                            kb = K;
                            K = l;
                            W = E - K / h / Wb;
                            if (!(J & 1)) {
        ...
        function uc(c) {
            var a = b.$EvtSrc(c), d = b.Lb(a, "1", ub);
            if (u === d)if (O) {
                b.$StopEvent(c);
                while (a && u !== a) {
        ...
        function Sb(h, g, m, o) {
            if (Bb && (!D && (G || !(F & 12)) || n.$NaviQuitDrag)) {
                ...
                var a = b;
                if (!(J & 1))if (o) a = v(a); else if (J & 2 && (a < 0 && !L || a > q - t && L >= q - t)) a = a < 0 ? q - t : 0; else a = c.max(0, c.min(a, q - t));
                var l = (a - e) % q;
                a = e + l;
                var i = e == a ? 0 : g * c.abs(l), j = 1;
        ...
        a.gd = function (a) {
            var d = c.ceil(v(mb / qb)), b = v(a - L + d);
            if (b > t) {
                if (a - L > q / 2) a -= q; else if (a - L <= -q / 2) a += q
            } else a = L + b - d;
            if (!(J & 1)) a = v(a);
            return a
        };
        a.Ub = function (y, l) {
            ...
            V = b.s({$Class: r}, n.$CaptionSliderOptions);
            ...
            b.$Each(m, function (a, d) {
                ...
                if (c == "loading") P = a; else {
                    if (c == "slides") z = a;
                    if (c == "navigator") sb = a;
                    if (c == "arrowleft") Pb = a;
                    if (c == "arrowright") Mb = a;
                    if (c == "thumbnavigator") ib = a;
                    if (a.tagName == "DIV" || a.tagName == "SPAN") Zb[c || d] = new vc(a, c == "slides", b.Of(["slides", "thumbnavigator"])[c])
                }
            });
            P = P || b.$CreateDiv(h);
            wb = b.$CssWidth(z);
            ...
            if (n.$HWA) yb = function (a, c, d) {
                b.nc(a, {$TranslateX: c, $TranslateY: d})
            };
            w = n.$AutoPlay & 63;
            a.Pb = l;
            b.$Attribute(u, ub, "1");
