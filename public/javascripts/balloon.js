...
function addBalloon() {
    ...
    var BalloonText = new fabric.IText("Text", {
        ...
        strokeWidth: 1,
        fill: "#000",
        left: balloon.left + balloon.width / 2,
        top: balloon.top + balloon.height / 2,
		originX:'center',
		originY:'center',
	...
	group.on('scaling', function () {
		...
		console.log(group.scaleY);
		BalloonText.scaleX = 1/group.scaleX;
		BalloonText.scaleY = 1/group.scaleY;
        BalloonText.fontSize = group.scaleY * 10;
		canvas.renderAll();
    });
};